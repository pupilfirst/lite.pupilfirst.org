...
let PathwayItem = ({ number, title, description, actions, isLast = false }) => {
  return (
    <div
      className={`relative px-8 pb-6 border-primary-500 border-dashed ${
        isLast ? "" : "border-l-2"
      }`}
    >
      ...
      <h3 className="text-secondary-500 text-xl lg:text-2xl">{title}</h3>
...
let AssetDownloadButton = ({ title, actionText, url, download = true }) => {
  return (
    <div>
...
export default function PathWayToJoinFDP() {
  return (
    <div>
      <PathwayItem
        number="1"
        title="Join LITE FDP  by ATAL Academy"
        description=""
        actions={[
          {
      ...
      <PathwayItem
        number="2"
        title="Facilitate signing off LITE MOU"
      ...
      <PathwayItem
        ...
        description="Submit AICTE Model Curriculum along with your training completion letter to University"
        actions={[
          {
            title: "Letter from Head of Institution to University",
            actionText: "Download template",
            url: "",
          },
          {
            title: "Approval Orders issued by University",
            actionText: "Download template",
            url: "",
          },
        ]}
      ...
      <PathwayItem
        number="5"
        title="Publish Academic Timetable"
        ...
        actions={[
          {
            ...
            actionText: "Download time table",
            url: "",
          },
        ]}
      />
      <PathwayItem
        number="6"
        title="Start Admissions in January 2023 "
        ...
        actions={[
          {
            ...
            actionText: "Download Admissions Kit",
            url: "",
          },
        ]}
        isLast={true}
