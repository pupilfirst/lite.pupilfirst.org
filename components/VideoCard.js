...
export default function VideoCard({
  ...
  return (
    <div className="w-full flex gap-5 items-center p-5 rounded-lg bg-gradient-to-tl from-white to-primary-50 border-2 border-primary-100">
      <div
        className="w-2/5 h-32 relative rounded-lg overflow-hidden"
      ...
      {open && (
        <ClientOnlyPortal selector="#modal">
          <div className="fixed inset-0 bg-black/70 z-50 flex flex-col py-12">
            <button
              className="text-white bg-primary-500 w-max p-5 mx-auto rounded-full -mb-8 z-50"
