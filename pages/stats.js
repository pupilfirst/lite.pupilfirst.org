              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-12 2xl:gap-5 px-0 pb-10 lg:pb-20">
                    ...
                    <div className="relative">
                      <div className="space-y-4">
                        <div className="stats__side-nav-item rounded-lg hover:bg-primary-100 hover:text-secondary-500 transition ">
                          <a
                            className="flex items-center space-x-3 p-4 text-sm font-medium"
                ...
                <div className="lg:col-span-9 2xl:col-span-8">
                  <section id="overall-application-stats" className="pt-10">
                    ...
                    <div className="grid lg:grid-cols-3 gap-4 lg:gap-8 pt-8">
                      <div className="bg-white grid grid-rows-2 rounded-xl shadow">
                        ...
                        <div className="grid grid-cols-2 bg-gray-100 bg-opacity-75 rounded-b-xl px-4 py-2 md:p-4">
                          <div>
                  ...
                  >
                    ...
                    <p className="pt-2 text-sm lg:text-lg">
                      The list of institutions selected on a provisional basis
                      for the Academic Year 2021-22 along with names of two
                      faculty members from the institute are published. Training
                      would be given for both the faculty members and
                      performance and successful course completion will decide
                      on final faculty selection as the “Faculty Coordinator”
                      for the course along with the Head of Institute.
                    </p>
                              ...
                              <tbody className="border bg-white divide-y divide-gray-200 text-sm">
                                ...
                                <tr className="divide-x divide-gray-200">
                                  ...
                                  <td className="px-4 py-2 font-medium">
                                    ...
                                    Studies And Research (Constituent Institute
                                ...
                                <tr className="divide-x divide-gray-200">
                                  ...
                                  <td className="px-4 py-2 font-medium">
                                    Trinity Institute of Technology and
                                    Research, Bhopal
                                  </td>
                                  <td className="px-4 py-2">
                                    Affiliated College to University
