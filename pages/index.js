            ...
            <div className="flex space-y-4 md:space-y-0 flex-col md:flex-row justify-between">
              <div className="md:w-8/12 p-4 lg:p-10">
                ...
                <p className="mt-4 text-base lg:text-lg">
                  Pupilfirst is an open-source technology organisation with a
                  mission to transform classroom education into a
                  learner-centred model.
                </p>
                <p className="mt-4 text-base lg:text-lg">
                  Pupilfirst is the technology partner of AICTE for the
                  Leadership in Teaching Excellence Programme that aims to train
                  100,000 faculty and 2.4 Crore students in emerging
                  technologies using learner-centered pedagogy.
                </p>
                <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 space-x-0 md:space-x-2 mt-8 text-sm md:text-base">
                  <p className="text-gray-600">Learn More at: </p>
                  <a
                    className="flex items-center space-x-2 text-secondary-500 font-semibold hover:underline hover:bg-secondary-50"
                    target="_blank"
                    href="https://www.aicte-india.org/sites/default/files/fdc/AICTE-LITE%20Programme.pdf"
                  >
                    <svg
                    ...
                    <span>AICTE-LITE Programme.pdf</span>
                  </a>
                </div>
              </div>
